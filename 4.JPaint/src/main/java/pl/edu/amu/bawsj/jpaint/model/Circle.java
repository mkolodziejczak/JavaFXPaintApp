 ...
 */
public class Circle extends Drawable implements Fillable, Strokable
{
    ...
    public Circle(GraphicsContext gc, Paint strokeColor, Paint fillColor)
    {
        super(gc);
    ...
    public void draw()
    {
        ...
        gc.fillOval(this.start.getXValue(), this.start.getYValue(), this.width, this.height);
        gc.strokeOval(this.start.getXValue(), this.start.getYValue(), this.width, this.height);
    }
    ...
    public void setUpObject(Coords start, Coords end, Boolean isCircle)
    {
